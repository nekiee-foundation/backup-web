    ...
    <header class="header">
      ...
      <!-- Modal -->
            <div class="modal fade" id="camp" tabindex="-1" role="dialog">
                  ...
                  <div class="modal-content p-30 pt-10">
                    ...
                    <select name="camp_id" id="camp_id" class="form-control">
                        ...
                        for($i=0; $row2 = $camp_list->fetch(); $i++){
                          ?>
                            <option value ="0" camp_name="<?php echo $row2['camp_id'] ?>"><?php echo $row2['camp_name'] ?></option>
                            <?php } ?>
                          </select>
                    </div>
                      <div class="row">
              ...
              <div class="modal fade" id="camp1" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                  <div class="modal-content p-30 pt-10">
      ...
      <div class="col-sm-6 col-md-3 col-lg-3">
        <div class="causes bg-lighter box-hover-effect effect1 maxwidth500 mb-sm-30">
          ...
          <div class="causes-details clearfix border-bottom p-15 pt-10">
            ...
            <div class="mt-10">
             <a class="btn btn-dark btn-theme-colored btn-flat btn-sm pull-left mt-10" data-toggle="modal" data-target="#camp1" href="#">Donate</a>
