...
if(preg_match('/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i',$useragent)||preg_match('/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i',substr($useragent,0,4)))
	header('Location: https://neikee.com/Jamghat/campaign_mobile.php');
$donors = 0;
...
if ($row['total_amount_raise']==0) {
	...
	$per = 0.01*(627000 - $amount_raised)/627000;
}
				...
				<div class="header-nav-wrapper">
					<div class="container-fluid p-0">
						<div id="menuzord-verticalnav" class="menuzord">
							<a class="menuzord-brand p-30" href="javascript:void(0)"><img width="auto" height="100" alt="logo" src="http://jamghat.org/images/logo.png"></a>
							<div>
								<div class="item">
									<div class="causes bg-darker box-hover-effect effect1 sm-maxwidth500 mb-sm-30">
										<div class="causes-details clearfix border-bottom p-15 pt-10">
											<p class="mb-5 mt-5"><span class="text-uppercase text-theme-colored"><strong>Children Dont' Belong on the Streets</strong></span>
												<div class="clearfix"></div>Children don’t belong on the streets and that’s exactly what Jamghat has done for a bunch of street kids; taken them out of the dangerous streets and provided them a comfortable home environment where they can evolve as physically and emotionally healthy, self-dependent individuals, living a life of their choice.</p>
								...
								<div class="container-fluid p-0">
									...
									<div class="rev_slider_wrapper">
										<div class="rev_slider" data-version="5.0">
											<ul>
												<!-- SLIDE 1 -->
												<li data-index="rs-1" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="../images/Jamghat/Jamghat(12).jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
													<!-- MAIN IMAGE -->
													<img src="../images/Jamghat/Jamghat(10).JPG"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
													<!-- LAYERS -->
									...
									<!-- SLIDE 2 -->
									<li data-index="rs-2" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="../images/Jamghat/Jamghat(14).jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
										<!-- MAIN IMAGE -->
										<img src="../images/Jamghat/Jamghat(7).JPG"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
										<!-- LAYERS -->
						...
						<!-- SLIDE 3 -->
						<li data-index="rs-3" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="../images/Jamghat/Jamghat(15).jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
							<!-- MAIN IMAGE -->
							<img src="../images/Jamghat/Jamghat(12).JPG"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
							<!-- LAYERS -->
				...
				<div class="featured-project">
					<div class="item">
						<div class="causes bg-lighter box-hover-effect effect1 sm-maxwidth500 mb-sm-30">
							<div class="causes-details clearfix border-bottom p-15 pt-10">
								<p class="mb-5 mt-5"><span class="text-theme-colored">Jamghat manages two homes for children; one for the boys and another one for girls. <strong>26 orphaned or abandoned boys and girls make Jamghat their home and live as a family, go to school, attend tuitions, attend counselling sessions, play games and celebrate birthdays.</strong> Had it not been for these two homes, the children would be at the traffic signals knocking on your car begging, rag picking, stealing and scrounging for food from the overflowing dustbins- at nightfall, sleeping inside drain pipes, hiding from police beatings.
								</p>
							</div>
							<div class="causes-details clearfix border-bottom p-15 pt-10">
								<p class="mb-5 mt-5"><b>A Day Care Centre – for street children in Old Delhi:</b> The day care centre – Aangan, was started in 2008 and since then we have been working directly with the most vulnerable of street children through this centre. In partnership with Max India Foundation, the day care centre offers food, bathing facilities, formal and non-formal education opportunities and a safe place to be a child off the streets of Old Delhi to 30-50 children every day.
								</p>
							</div>
						</div>
					</div>
...
<!-- divider: Donate Now -->
<section id="donate-now" class="divider"  data-bg-img="../images/bg_jamghat.JPG">
		...
		<div class="row">
			<div class="col-md-7">
				<div class="bg-light-transparent p-40">
					...
					<div class="row">
						<p>Jamghat wishes to form a <b><big>joyful, open, living, learning collective</b></big> that facilitates growth and takes care of children’s needs according to age and for this, it seeks your generous support. They <b>provide a residential program to children who are without a safe home or family</b> and also encourage and support reconciliation with families whenever possible. Trying to <b>create an environment where street children are respected as individuals</b> working for their livelihood is what they are striving to do.<hr /> Let’s help nurture these children and take care of the educational as well as vocational training needs.
						</p>
				...
				<div class="col-md-12">
					<div class="gallery-isotope grid-5 gutter-small clearfix" data-lightbox="gallery">
						...
						<div class="gallery-item">
							<div class="thumb">
								<img alt="project" src="../images/Jamghat/Jamghat(3).jpg" class="img-fullwidth">
								<div class="overlay-shade"></div>
								<div class="icons-holder">
									<div class="icons-holder-inner">
										<div class="styled-icons icon-dark icon-circled icon-theme-colored">
											<a href="../images/Jamghat/Jamghat(3).jpg"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="gallery-item">
							<div class="thumb">
								<img alt="project" src="../images/Jamghat/Jamghat(4).jpg" class="img-fullwidth">
								<div class="overlay-shade"></div>
								<div class="icons-holder">
									<div class="icons-holder-inner">
										<div class="styled-icons icon-dark icon-circled icon-theme-colored">
											<a href="../images/Jamghat/Jamghat(4).jpg"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="gallery-item">
							<div class="thumb">
								<img alt="project" src="../images/Jamghat/Jamghat(5).JPG" class="img-fullwidth">
								<div class="overlay-shade"></div>
								<div class="icons-holder">
									<div class="icons-holder-inner">
										<div class="styled-icons icon-dark icon-circled icon-theme-colored">
											<a href="../images/Jamghat/Jamghat(5).JPG"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="gallery-item">
							<div class="thumb">
								<img alt="project" src="../images/Jamghat/Jamghat(6).JPG" class="img-fullwidth">
								<div class="overlay-shade"></div>
								<div class="icons-holder">
									<div class="icons-holder-inner">
										<div class="styled-icons icon-dark icon-circled icon-theme-colored">
											<a href="../images/Jamghat/Jamghat(6).jpg"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="gallery-item">
							<div class="thumb">
								<img alt="project" src="../images/Jamghat/Jamghat(9).JPG" class="img-fullwidth">
								<div class="overlay-shade"></div>
								<div class="icons-holder">
									<div class="icons-holder-inner">
										<div class="styled-icons icon-dark icon-circled icon-theme-colored">
											<a href="../images/Jamghat/Jamghat(9).JPG"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xs-12 col-sm-12 col-md-12">
							<div class="icon-box left media bg-deep p-30 mb-20"> <a class="media-left pull-left" href="#"> <i class="pe-7s-map-2 text-theme-colored"></i></a>
								<div class="media-body"> <strong>ABOUT THE NGO PARTNER</strong>
									<p><br>JAMGHAT, a Group of Street Children<br>
										Contact Person: Amit Sinha, Founder & Director<br>
										Location: New Delhi<br><br><br><br></p>
									</div>
								</div>
							</div>
    			...
    			<div class="icon-box left media bg-deep p-30 mb-20"> <a class="media-left pull-left" href="#"> <i class="pe-7s-mail text-theme-colored"></i></a>
    				<div class="media-body"> <strong>DETAILED INFORMATION ABOUT THE CAMPAIGN</strong>
    					<p>Connect with us at ankit@neikee.com for more information or download a detailed PDF about the campaign and how the funds would be utilized by clicking the button.
    						<a style="padding: 10px;" target="_blank" type="submit" href= "../documents/Campaign Details_Jamghat.pdf" class="btn btn-flat btn-dark btn-theme-colored mt-10 pl-30 pr-30" data-loading-text="Please wait...">Campaign Details - Children Don't Belong on the Streets</a></p>
    					</div>
    				</div>
    			</div>
                <!--<div class="col-xs-12 col-sm-6 col-md-12">
...
<div class="modal fade" id="campRose" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content p-30 pt-10">
			<h3 class="text-center text-theme-colored mb-20">Donate to Jamghat Foundation - Children Dont' Belong on the Streets</h3>
